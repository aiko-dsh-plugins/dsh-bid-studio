...
const projectId = { key: 'projectId', label: '所属项目', type: 'string', required: true };
const runId = { key: 'runId', label: '流程运行', type: 'string', required: true };
/** Installable bid ontology: work objects, traceability links, Actions, and review state. */
export const BID_ONTOLOGY = {
