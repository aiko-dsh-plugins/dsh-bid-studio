...
import type { CreateOntologyObjectRequest, OntologyActionId, OntologyDefinition, OntologyFunctionId, OntologyFunctionValue, OntologyImplementation, OntologyLink, OntologyLinkId, OntologyLinkQuery, OntologyObject, OntologyObjectTypeId, OntologyPropertyValue, CreateOntologyLinkRequest, UpdateOntologyObjectRequest } from './types.ts';
...
export declare abstract class OntologyRuntime extends Service {
     ...
     */
    abstract executeFunction(functionId: OntologyFunctionId, input: Readonly<Record<string, OntologyPropertyValue>>): Promise<OntologyFunctionValue>;
    /**
