 ...
 * @returns Branded id.
 */
export declare const OntologyDefinitionId: (value: string) => OntologyDefinitionId;
/**
 * Construct an object-type id from a trusted package-owned literal.
 * @param value - Namespaced id.
 * @returns Branded id.
 */
export declare const OntologyObjectTypeId: (value: string) => OntologyObjectTypeId;
/**
 * Construct a link-type id from a trusted package-owned literal.
 * @param value - Namespaced id.
 * @returns Branded id.
 */
export declare const OntologyLinkTypeId: (value: string) => OntologyLinkTypeId;
/**
 * Construct a Function id from a trusted package-owned literal.
 * @param value - Namespaced id.
 * @returns Branded id.
 */
export declare const OntologyFunctionId: (value: string) => OntologyFunctionId;
/**
 * Construct an Action id from a trusted package-owned literal.
 * @param value - Namespaced id.
 * @returns Branded id.
 */
export declare const OntologyActionId: (value: string) => OntologyActionId;
/**
 * Construct an object id from a trusted runtime value.
 * @param value - Provider id.
 * @returns Branded id.
 */
export declare const OntologyObjectId: (value: string) => OntologyObjectId;
/**
 * Construct a link id from a trusted runtime value.
 * @param value - Provider id.
 * @returns Branded id.
 */
export declare const OntologyLinkId: (value: string) => OntologyLinkId;
...
export type OntologyFunctionResultDefinition = {
    ...
    readonly objectType: OntologyObjectTypeId;
} | {
...
export type OntologyActionHandler = (input: Readonly<Record<string, OntologyPropertyValue>>, context: OntologyActionContext) => Promise<unknown>;
...
export type OntologyFunctionHandler = (input: Readonly<Record<string, OntologyPropertyValue>>, context: OntologyReadContext) => Promise<unknown>;
